#ifndef _analysisUtils_h
#define _analysisUtils_h
...
namespace common{
    ...
    void TLorentzVectortod4(const TLorentzVector& lv, double* d);
...
namespace common{
    ...
    std::vector<double> parametersLV(const std::vector<TLorentzVector>& v_lv, const LVParameter& parameter);
    ...
    void orderIndices(int& index1, int& index2, const std::vector<TLorentzVector>& v_lv, const LVParameter& parameter, const bool absoluteValue =false);
    ...
    void orderIndices(std::vector<int>& v_index, const std::vector<TLorentzVector>& v_lv, const LVParameter& parameter, const bool absoluteValue =false);
    ...
    void selectIndices(std::vector<int>& v_index, const std::vector<TLorentzVector>& v_lv, const LVParameter& parameter,
    ...
    void selectIndicesLeptonIso(std::vector<int>& v_index, const std::vector<TLorentzVector>& v_lvLep, const std::vector<TLorentzVector>& v_lvJet);
    ...
    /// If the vector is empty, return -1
    int extremumIndex(const std::vector<TLorentzVector>& v_lv, const LVParameter& parameter, const bool maximumValue =true);
    ...
    void orderTLorentzVector(TLorentzVector& lv1, TLorentzVector& lv2, const TLorentzVector& inputLv1, const TLorentzVector& inputLv2, const LVParameter& parameter, const bool absoluteValue =false);
}
