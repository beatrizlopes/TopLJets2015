...
KinematicReconstruction_LSroutines::KinematicReconstruction_LSroutines(const double& mass_Wp, const double& mass_Wm)
{
    ...
    mw_    = mass_Wm;
    mwbar_ = mass_Wp; 
    //std::cout << "KinematicReconstruction_LSroutines: mw_: " << mass_Wm << std::endl;
    //std::cout << "KinematicReconstruction_LSroutines: mwbar_: " << mass_Wp << std::endl;
    ml_    = 0.;
    mal_    = 0.;
    mv_=0;
    mav_=0;
...
void KinematicReconstruction_LSroutines::setTrueInfo(const TLorentzVector& LV_Top, const TLorentzVector& LV_AntiTop,const TLorentzVector& LV_Neutrino,const TLorentzVector& LV_AntiNeutrino)
{
...
void KinematicReconstruction_LSroutines::doAll()
{
        ...
        //std::cout << "KinematicReconstruction_LSroutines::doAll -> coeffs_[0],coeffs_[1],coeffs_[2],coeffs_[3],coeffs_[4] : " << coeffs_[0] << ", " << coeffs_[1] << ", " << coeffs_[2] << ", " << coeffs_[3] << ", " << coeffs_[4] << std::endl;
        nSol_=vect_pxv_[0];
            ...
            for(int i=1;i<=nSol_;++i)
            {
                ...
                TS_temp.wp = wbar_;
                //std::cout << "KinematicReconstruction_LSroutines::doAll -> TS_temp.wp.M():  " << TS_temp.wp.M() << std::endl;
                TS_temp.wm = w_;
                //std::cout << "KinematicReconstruction_LSroutines::doAll -> TS_temp.wm.M():  " << TS_temp.wm.M() << std::endl;
                TS_temp.neutrino = neutrino_;
                TS_temp.neutrinobar = neutrinobar_;
                
                //proton Energy [GeV]  
                //MOD: it was 4000, because this was for analaysis at 8 TeV!! Set for 13 TeV
                double protonE = 6500; //FIXME:  set as global variable
...
//Sort solutions with highest weight first
...
{
    a1_ = ((b_.E()+al_.E())*(mwbar_*mwbar_-mal_*mal_-mv_*mv_)-al_.E()*(mt_*mt_-mb_*mb_-mal_*mal_-mv_*mv_)+2*b_.E()*al_.E()*al_.E()-2*al_.E()*(al_.Vect().Dot(b_.Vect())))/(2*al_.E()*(b_.E()+al_.E()));
    ...
    b1_ = ((bbar_.E()+l_.E())*(mw_*mw_-ml_*ml_-mav_*mav_)-l_.E()*(mtbar_*mtbar_-mbbar_*mbbar_-ml_*ml_-mav_*mav_)+2*bbar_.E()*l_.E()*l_.E()-2*l_.E()*(l_.Vect().Dot(bbar_.Vect())))/(2*l_.E()*(bbar_.E()+l_.E()));
    ...
    c22_ = (sqr((mwbar_*mwbar_-mal_*mal_-mv_*mv_))-4*(sqr(al_.E())-sqr(al_.Pz()))*sqr(a1_/a4_)-4*(mwbar_*mwbar_-mal_*mal_-mv_*mv_)*al_.Pz()*(a1_/a4_))/sqr(2*(b_.E()+al_.E())); 
    c21_ = (4*(mwbar_*mwbar_-mal_*mal_-mv_*mv_)*(al_.Px()-al_.Pz()*(a2_/a4_))-8*(sqr(al_.E())-sqr(al_.Pz()))*(a1_*a2_/sqr(a4_))-8*al_.Px()*al_.Pz()*(a1_/a4_))/sqr(2*(b_.E()+al_.E())); 
    c20_ = (-4*(sqr(al_.E())-sqr(al_.Px()))-4*(sqr(al_.E())-sqr(al_.Pz()))*sqr(a2_/a4_)-8*al_.Px()*al_.Pz()*(a2_/a4_))/sqr(2*(b_.E()+al_.E())); 
    c11_ = (4*(mwbar_*mwbar_-mal_*mal_-mv_*mv_)*(al_.Py()-al_.Pz()*(a3_/a4_))-8*(sqr(al_.E())-sqr(al_.Pz()))*(a1_*a3_/sqr(a4_))-8*al_.Py()*al_.Pz()*(a1_/a4_))/sqr(2*(b_.E()+al_.E())); 
    ...
    D22 = (sqr((mw_*mw_-ml_*ml_-mav_*mav_))-4*(sqr(l_.E())-sqr(l_.Pz()))*sqr(b1_/b4_)-4*(mw_*mw_-ml_*ml_-mav_*mav_)*l_.Pz()*(b1_/b4_))/sqr(2*(bbar_.E()+l_.E())); 
    D21 = (4*(mw_*mw_-ml_*ml_-mav_*mav_)*(l_.Px()-l_.Pz()*(b2_/b4_))-8*(sqr(l_.E())-sqr(l_.Pz()))*(b1_*b2_/sqr(b4_))-8*l_.Px()*l_.Pz()*(b1_/b4_))/sqr(2*(bbar_.E()+l_.E())); 
    D20 = (-4*(sqr(l_.E())-sqr(l_.Px()))-4*(sqr(l_.E())-sqr(l_.Pz()))*sqr(b2_/b4_)-8*l_.Px()*l_.Pz()*(b2_/b4_))/sqr(2*(bbar_.E()+l_.E())); 
    D11 = (4*(mw_*mw_-ml_*ml_-mav_*mav_)*(l_.Py()-l_.Pz()*(b3_/b4_))-8*(sqr(l_.E())-sqr(l_.Pz()))*(b1_*b3_/sqr(b4_))-8*l_.Py()*l_.Pz()*(b1_/b4_))/sqr(2*(bbar_.E()+l_.E())); 
